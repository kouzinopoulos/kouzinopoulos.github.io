...
You will explore and evaluate BNN-based DL approaches for change detection using publicly available EO datasets. The project will focus on disaster-related change detection scenarios, including (but not limited to) wildfire and flood monitoring [7-9]. Starting from compact change detection architectures (e.g., Siamese neural networks or embedding-based models [1-4]), you will investigate how binarization affects the performance of the model. The project will evaluate different BNN design strategies and possible hybrid precision strategies for layers that are more sensitive to accuracy degradation. A comparative analysis will be performed to assess the trade-offs between detection performance, model size and suitability for onboard FPGA deployment. The deployment phase will consider FPGA-oriented tools for BNNs, such as FINN and/or Vitis HLS. 
...
<li>[2] Valsamis, D. et al., (2024) "Towards Advanced Wildfire Analysis: A Siamese Network-Based Change Detection Approach Through Self-Supervised Learning." doi: 10.1109/CBMI62980.2024.10858874.</li>
<li>[3] Herec, J. et al., (2026) "STTORM-CD low-demand and high-impact disaster monitoring onboard satellites using change detection." https://doi.org/10.1038/s41598-025-32598-3</li>
